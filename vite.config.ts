...
export const EXTENSION_ID = 'com.donyaep.DonyTools'
...
export default defineConfig({
  ...
  build: {
    // CEP 11 ships Chromium 88 (After Effects 2021+). Pinned by hand: Vite's
    // default target is newer than any CEP runtime.
    target: 'chrome88',
    outDir: 'dist',
    emptyOutDir: true,
    assetsDir: 'assets',
